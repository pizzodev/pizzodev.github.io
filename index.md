...
<section class="hero">
  <div class="hero-left">
    ...
    <p class="hero-bio">Mobile-first engineer based in Switzerland. Specializing in Kotlin Multiplatform and Flutter, leading cross-functional delivery teams across fintech, insurance, and energy sector clients at adesso Schweiz AG.</p>
...
<section class="section">
  ...
  <div class="project-grid">
    ...
    <a class="project-card" href="https://github.com/pizzodev/CMImageViewer" target="_blank" rel="noopener">
      ...
      <div class="project-desc">// placeholder</div>
    </a>

    <a class="project-card" href="https://github.com/pizzodev/MaUILuganoMeteo" target="_blank" rel="noopener">
      <div class="project-lang">C#</div>
      <div class="project-name">MaUILuganoMeteo</div>
      <div class="project-desc">// placeholder</div>
    </a>
